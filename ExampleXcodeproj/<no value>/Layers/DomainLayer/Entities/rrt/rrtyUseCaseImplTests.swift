...
class rrtUseCaseImplTests: XCTestCase {

    // <no value>
    // <no value>
    // <no value>
    var sut: PartialMockrrtyUseCaseImpl!
    
    var mockRepository: MockrrtRepository!
    
    override func setUp() {
        super.setUp()
        // Put setup code here. This method is called before the invocation of each test method in the class.
        
        mockRepository = MockrrtRepository()
        
        sut = PartialMockrrtyUseCaseImpl(mockRepository: MockrrtRepository)
    }
    ...
    func test_GivenNilParam_WhenValidateParams_ThenItShouldThrowNilIdentifierError() {
        ...
        XCTAssertThrowsError(try sut.validateParams(), "") { (error) in
            XCTAssert(error is rrtUseCaseNilParamError)
        }
